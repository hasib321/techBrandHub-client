    ...
    <>
      <li>
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "text-white  font-bold bg-[#02c173] hover:text-white rounded-full hover:bg-[#02c173]"
              : ""
          }
        >
    ...
    <div>
      <div className="navbar ">
        ...
        {user ? (
          ...
          <div className="navbar-end ">
            <Link to="/login">
              <button className="text-white bg-[#02c173] px-7 py-3 rounded-full font-semibold">
                login
              </button>
            </Link>
          </div>
